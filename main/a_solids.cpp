...
void a_solids() {
    ...
    //scene->add(new Quadric(1, 2, 6, 0, 0, 0, 3, 3, 1.5, 1.5, nullptr, nullptr));
    //scene->add(new Quadric(1, 6, 2, 1, 0.5, 0, 2, 18, 10, 4, nullptr, nullptr));
    //scene->add(new Quadric(2, 2, 0, 1, 4, 2, 6, 1.5, 4, 9, nullptr, nullptr));
    //scene->add(new Quadric(1, 1, 1, 1, 2, 4, 2, 1.5, 2, 3, nullptr, nullptr));
