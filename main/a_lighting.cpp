...
void renderCornellboxC(float scale, const char* filename) {
    ...
    PerspectiveCamera cam(Point(278 * scale, 500 * scale, -800 * scale), Vector(0, -0.2, 0.5), Vector(0, 1, 0), 0.686f, 0.686f);

    DummyMaterial* mat = new DummyMaterial();

    scene->add(new InfinitePlane(Point(0, 0, 0), Vector(0, 1, 0), nullptr, mat));
    ...
    //point light
    world.light.push_back(new ProjectiveLight(Point(400 * scale, 200 * scale, 100.0f * scale), RGBColor::rep(40000.0f * scale * scale)));
    //world.light.push_back(new PointLight(Point(490 * scale, 329.99f * scale, 279.5f * scale), RGBColor(60000.0f * scale * scale, 0, 0)));
    //world.light.push_back(new PointLight(Point(40 * scale, 329.99f * scale, 279.5f * scale), RGBColor(0, 60000.0f * scale * scale, 0)));
...
void a_lighting() {
    ...
    renderCornellboxC(0.01f, "julia.png");
}